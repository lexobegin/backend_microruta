...
from ....models import LineaRutaPunto, Ruta, Punto
...
async def get_rutas_linea(linea_id: int, db: Session = Depends(get_db)):
    ...
    for ruta in rutas:
        ...
        resultados.append({
            ...
            'tiempo_total': ruta.tiempo_total_minutos,
            'puntos': puntos_data
        })
...
async def calcular_ruta_optima(
    ...
    ##Args:
    ##    request: Punto origen y destino
...
async def obtener_lineas_punto(
    ...
    return {"punto_id": punto_id, "lineas": lineas}
"""
